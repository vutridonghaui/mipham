    ...
    <div class="item a">
        <div class="product-box">
            <div class="product-thumbnail flexbox-grid">
                <a href="index.php?area=frontend&controller=chitiet&id=<?php echo $rows->id; ?>&category_id=<?php echo $rows->category_id; ?>" title=""> <img style="padding: 10px; " src="assets/upload/product/<?php echo isset($rows->img) ? $rows->img : ''; ?>" alt="<?php echo $rows->name ?>" /> 
                </a>
