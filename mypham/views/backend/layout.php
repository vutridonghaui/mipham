...
<body class="hold-transition skin-blue sidebar-mini">
    <div class="wrapper">
        ...
        <header class="main-header">
            <!-- Logo -->
            <a href="index.php?area=backend&controller=home" class="logo">
        ...
        <aside class="main-sidebar">
            ...
            <section class="sidebar">
                ...
                <ul class="sidebar-menu" data-widget="tree">
                    ...
                    <li>
                        <a href="index.php?area=backend&controller=donhang&action=list_donhang">
                            <i class="fa fa-th"></i> <span>Đơn hàng</span>
                        </a>
                    </li>

                    <li>
                        <a href="index.php?area=backend&controller=gioiThieu">
